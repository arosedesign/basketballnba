	...
	public function html() {
		...
		<div class="post-slider-home-<?php echo $type ?>">
			...
			<?php while ( $entries->have_posts() ) : $entries->the_post(); ?>
				...
				<div class="ls-layer slide<?php echo $count; ?>"  style="slidedirection: top; slidedelay: 8000; durationin: 1500; durationout: 1500; easingin: easeInOutQuint; easingout: easeInOutQuint; delayin: 0; delayout: 0; transition2d: 5,11,12,13,14;"> 
			...
			<div class="rev_slider forcefullwidth_wrapper_tp_banner">
				...
				?>
					...
					<li data-transition="fade" data-slotamount="10">
						...
						<div class="tp-caption blackfloor tp-resizeme skewfromrightshort fadeout" data-x="-1000" data-y="['bottom','bottom','bottom','bottom']" data-width="5000" data-height="100" data-start="1200" data-speed="500" data-easing="Power4.easeOut"  style="background-color: rgba(34, 34, 38, 0.3);" > 
						</div>
						
						
					    <div class="tp-caption tp-resizeme lightgrey_sectionider  skewfromrightshort fadeout"
