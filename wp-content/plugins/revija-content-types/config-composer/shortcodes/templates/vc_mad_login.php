	...
	public function html() {
		...
		<div class="section widget_member_login login_form">
			...
			<?php endif; ?>
			 ...
			 <form action="<?php echo wp_login_url( revija_curPageURL() ); ?>" method="post" name="loginform" >
				<ul>
				  <li>
				  ...
				  <li class="clearfix custom_box">
					...
					<input name="rememberme" type="checkbox" value="forever" id="rememberme">
					<label for="rememberme"><?php esc_html_e( 'Remember me', 'revija' ); ?></label>
					
					<a href="<?php echo wc_lostpassword_url(); ?>" class="f_right"><?php esc_html_e( 'Forgot your password?', 'revija' ); ?></a>
					...
					<a href="<?php echo wp_lostpassword_url( get_permalink() ); ?>" class="f_right"><?php esc_html_e( 'Forgot your password?', 'revija' ); ?></a>
				...
				<span>
				  or
					<?php if ( !is_user_logged_in() ) { ?>
					    <a href="<?php echo $accountPage; ?>"><?php esc_html_e( 'Register', 'revija' ); ?></a>
					<?php } else {
						$current_user1 = wp_get_current_user();
						?>
						<a href="<?php echo wp_logout_url( revija_curPageURL() ); ?>">
