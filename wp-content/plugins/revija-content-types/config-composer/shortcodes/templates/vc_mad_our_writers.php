		...
		global $wpdb;
			...
			<div class="author_details clearfix">
			  <div class="f_left">
				...
				<a href="<?php echo $author_url; ?>" class="button button_type_3 button_grey_light"><?php echo count_user_posts( $id, $post_type = 'post' ); ?> <?php echo  esc_html__( 'articles', 'revija' ); ?></a>
			  </div>
				...
				<div class="widget widget_social_icons type_2 type_border clearfix">
				  <ul>
					...
					<li class="google_plus">
					  ...
					  <a target="_blank" href="<?php echo esc_url($googleplus); ?>">
					...
					<li class="vimeo">
					  ...
					  <a target="_blank" href="<?php echo esc_url($vimeo); ?>">
