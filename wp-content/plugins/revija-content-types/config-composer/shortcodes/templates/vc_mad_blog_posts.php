...
class WPBakeryShortCode_VC_mad_blog_posts extends WPBakeryShortCode {
	...
	public function html() {
		...
		<div class="<?php echo $blog_style_class; ?> blog_post  <?php echo $show_more; ?>  <?php echo $type_title; ?>">
		
		<?php if (!empty($title)): ?>
		
			<?php if ($type_title == 'big_title') { ?>
				<?php echo "<h2 class='section_title section_title_big'>" . esc_html($title) . "</h2>"; ?>
			<?php } else { ?>
				<?php echo "<h3 class='section_title'>" . esc_html($title) . "</h3>"; ?>
			<?php } ?>
			...
			<?php foreach ($this->entries->posts as $entry):
				...
				<div class="section_post_left">
						...
						<div class="post_text">
							...
							<a href="<?php echo esc_url($link); ?>" class="button button_type_2 button_more button_grey_light">
		...
		<ul class="row">
			...
			<?php if ( $post_loop == $advertising_after_post && $advertising != '') { 
				...
				<li class="col-lg-6 col-md-6 col-sm-6 col-xs-6 post-item clearfix" >
				<div class="section_advertising t_align_c clearfix">
				<?php echo $advertising; ?>
				</div>
				</li>
