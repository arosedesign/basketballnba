...
class WPBakeryShortCode_VC_mad_posts_most_liked extends WPBakeryShortCode {
	...
	public function html() {
		...
		$css_animation = $items = $gap = $type = $title = $title_color = $url_view_all = $posts_per_page = '';
		...
		<div class=" section_post_left mad_posts_most_liked mad_posts_most_liked_type1"  style="margin-top:<?php echo $gap; ?>px;" >
			...
			<?php endif; ?>
				...
				<?php while ( $entries->have_posts() ) : $entries->the_post(); ?>
					...
					<?php
						...
						$title_post = mad_post_content_truncate($post->post_title, $title_count, " ", "…");
		...
		<div class="  mad_posts_most_liked mad_posts_most_liked_type2"  style="margin-top:<?php echo $gap; ?>px;" >
		...
		<div class="  mad_posts_most_liked mad_posts_most_liked_type3"  style="margin-top:<?php echo $gap; ?>px;" >
