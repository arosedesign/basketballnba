...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'description' => esc_html__( 'Select type newsletter form.', 'revija' )
		),
		$mad_add_css_animation
	)
) );
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'param_name' => 'link',
			'description' => sprintf( esc_html__( 'Visit %s to create.', 'revija' ), '<a href="http://intagme.com" target="_blank">http://intagme.com</a>' )
		),
		$mad_add_css_animation
	)
) );
...
vc_map( array(
	'name' => esc_html__( 'Instagram Photos', 'revija' ),
	'base' => 'vc_mad_instagram_photos',
	'icon' => '',
	'category' => esc_html__( 'Content', 'revija' ),
	'description' => esc_html__( 'Instagram Photos', 'revija' ),
	'params' => array(
		array(
			'type' => 'textfield',
			'heading' => esc_html__( 'Widget title', 'revija' ),
		...
		array(
			...
			'heading' => esc_html__( 'Instagram embed iframe', 'revija' ),
			'param_name' => 'link',
			'description' => sprintf( esc_html__( 'Visit %s to create.', 'revija' ), '<a href="http://snapwidget.com" target="_blank">http://snapwidget.com</a>' )
		),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'param_name' => 'type_title',
			'value' => array(
				esc_html__( 'Big', 'revija' ) => 'big_title',
				esc_html__( 'Small', 'revija' ) => 'small_title'
			),
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'Read More', 'revija' ),
			'param_name' => 'show_more',
			'value' => array(
				esc_html__( 'Show', 'revija' ) => 'show_more',
				esc_html__( 'Hide', 'revija' ) => 'hide_more'
			),
			'description' => esc_html__( 'Read More show', 'revija' )
		),
		array(
			"type" => "term_categories",
			"term" => "category",
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'Title Count', 'revija' ),
			'param_name' => 'title_count',
			'value' => REVIJA_VC_CONFIG::array_number(1, 200, 1),
			'std' => 100,
			'description' => esc_html__( 'Select Post Title Count', 'revija' )
		),
		array(
			'type' => 'colorpicker',
	...
	'params' => array(
		...
		array(
			...
			'value' => array(
				...
				esc_html__( 'Type 6', 'revija' ) => 'type6'
			),
			'description' => esc_html__( 'Select Type Slider', 'revija' )
		),
		array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'Bullets', 'revija' ),
			'param_name' => 'bullets',
			'value' => array(
				esc_html__( 'No', 'revija' ) => 'false',
				esc_html__( 'Yes', 'revija' ) => 'true'
			),
			'dependency' => array(
					'element' => 'type',
					'value' => array('type5')
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'Slideshow', 'revija' ),
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__( 'Post Title Count', 'revija' ),
			'param_name' => 'title_count',
			'value' => REVIJA_VC_CONFIG::array_number(1, 100, 1),
			'std' => 20,
			'description' => esc_html__( 'Select Post Title Count', 'revija' )
		),
		array(
