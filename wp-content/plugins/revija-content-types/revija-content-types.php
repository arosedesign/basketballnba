...
add_action('plugins_loaded', 'config_import');

function config_import() {
			
			if (class_exists('Vc_Manager')) {
				include_once ROOT_PATH. '/config-composer/config.php';
			}
			
			if (!class_exists('WP_Import')) {
			 include ROOT_PATH. '/import/wordpress-importer.php';
			}
			 if (class_exists('WP_Import')) {
				 include ROOT_PATH. '/import/import-class.php';
				 include ROOT_PATH. '/import/export-class.php';
			 }
