...
<?php if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" method="post" enctype='multipart/form-data'>
		...
		?>
	 	...
	 	<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button button_type_icon_medium button_orange alt"><?php echo esc_html( $product->single_add_to_cart_text() ); ?><i class="fa fa-shopping-cart"></i></button>
