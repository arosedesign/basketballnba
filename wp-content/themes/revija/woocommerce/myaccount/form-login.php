...
<div class="login-holder"  id="customer_login">
		...
		<div class="login-content">
				...
				<form method="post" class="login">
					...
					<p class="form-row login_form_confirm">
						<input type="submit" class="woocommerce-Button button button_grey" name="login" value="<?php esc_html_e( 'Login', 'woocommerce' ); ?>" />
				...
				<div id="customer_login">
					...
					<form method="post" class="register">
						...
						<p class="form-row login_form_confirm">
							...
							<input type="submit" class="woocommerce-Button button button_grey" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
						</p>
