...
$mad_elements[] = array(
	...
	$mad_elements[] = array(
		...
		"slug"	=> 'revija',
		"type" 	=> "heading",
		"desc" 	=> esc_html__('Google recently changed the way their map service works. New pages which want to use Google Maps need to register an API key for their website. Older pages should  work fine without this API key. If the google map elements of this theme do not work properly you need to register a new API key.', 'revija'),
	);

	$mad_elements[] = array(
		"name" 	=> esc_html__('Google Maps API Key', 'revija'),
		"slug"	=> 'revija',
		"type" 	=> "textarea",
		"id" 	=> "api-key-google-maps",
		"desc" 	=> esc_html__('Enter a valid Google Maps API Key to use all map related theme functions.', 'revija'),
		"std"   => ""
	);
	...
	$mad_elements[] = array(
		"name" 	=> esc_html__('Style Widget Latest Tweets', 'revija'),
		"slug"	=> "revija",
		"type" 	=> "select",
		"id" 	=> "style_tweets",
		"options" => array(
			'carousel'  => esc_html__('Carousel', 'revija'),
			'list' => esc_html__('List', 'revija')
		),
		"std" => 'carousel',
		"desc" 	=> esc_html__('Style Widget Latest Tweets', 'revija'),
	);
...
/* ---------------------------------------------------------------------- */
	...
	$mad_elements[] = array(
		...
		$mad_elements[] = array(
			...
			$mad_elements[] = array(
				"name" => esc_html__("Page Title Font Size", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-page_title_font_size",
				"options" => "range",
				"range" => "12-30",
				"std" => "30px",
				"desc" => esc_html__("Page Title font size", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Page Title Font Weight", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-page_title_font_weight",
				"options" => $get_theme_font_weight,
				"std" => "600",
				"desc" => esc_html__("Page Title Font Weight", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Page Title  Font Family", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-page_title_font_family",
				"options" => $mad_google_webfonts,
				"std" => "Roboto:300,700,900,500,300italic",
				"desc" => esc_html__("Page Title Font Family", "revija"),
			);
			
			$mad_elements[] = array(
				"name" 	=> esc_html__("Page Title Font Color", "revija"),
				"slug"	=> "styling",
				"type" 	=> "color",
				"id" 	=> "styles-page_title_font_color",
				"std" 	=> "#3e454c",
				"default" 	=> "#3e454c",
				"desc" 	=> esc_html__("Page Title font color", "revija"),
			);
			
			
			
			$mad_elements[] = array(
				"name" 	=> esc_html__("Style Section Title", "revija"),
				"slug"	=> "styling",
				"type" 	=> "select",
				"id" 	=> "style_section_title",
				"options" => array(
					'style1' => esc_html__('Style 1', 'revija'),
					'style2'  => esc_html__('Style 2', 'revija')
				),
				"std" => 'style1',
				"desc" 	=> esc_html__("Style Section Title", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Section Title Font Size", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-section_title_font_size",
				"options" => "range",
				"range" => "12-20",
				"std" => "16px",
				"desc" => esc_html__("Section Title font size", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Section Title Font Weight", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-section_title_font_weight",
				"options" => $get_theme_font_weight,
				"std" => "500",
				"desc" => esc_html__("Section Title Font Weight", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Section Title  Font Family", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-section_title_font_family",
				"options" => $mad_google_webfonts,
				"std" => "Roboto:300,700,900,500,300italic",
				"desc" => esc_html__("Section Title Font Family", "revija"),
			);
			
			$mad_elements[] = array(
				"name" 	=> esc_html__("Section Title Font Color", "revija"),
				"slug"	=> "styling",
				"type" 	=> "color",
				"id" 	=> "styles-section_title_font_color",
				"std" 	=> "#3e454c",
				"default" 	=> "#3e454c",
				"desc" 	=> esc_html__("Section Title font color", "revija"),
			);
			...
			$mad_elements[] = array(
				"name" 	=> esc_html__("Style Footer Widget Title", "revija"),
				"slug"	=> "styling",
				"type" 	=> "select",
				"id" 	=> "footer_style_section_title",
				"options" => array(
					'style1' => esc_html__('Style 1', 'revija'),
					'style2'  => esc_html__('Style 2', 'revija')
				),
				"std" => 'style1',
				"desc" 	=> esc_html__("Style Footer Widget Title", "revija"),
			);
			
			
			
			$mad_elements[] = array(
				"name" => esc_html__("Footer Widget Title Font Size", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-footer_widget_title_font_size",
				"options" => "range",
				"range" => "12-20",
				"std" => "16px",
				"desc" => esc_html__("Footer Widget Title font size", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Footer Widget Title Font Weight", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-footer_widget_title_font_weight",
				"options" => $get_theme_font_weight,
				"std" => "500",
				"desc" => esc_html__("Footer Widget Title Font Weight", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Footer Widget Title Font Family", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-footer_widget_title_font_family",
				"options" => $mad_google_webfonts,
				"std" => "Roboto:300,700,900,500,300italic",
				"desc" => esc_html__("Footer Widget Title Font Family", "revija"),
			);
			...
			$mad_elements[] = array(
				"name" => esc_html__("Tabs Title Font Size", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-tabs_title_font_size",
				"options" => "range",
				"range" => "12-20",
				"std" => "16px",
				"desc" => esc_html__("Tabs Title font size", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Tabs Title Font Weight", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-tabs_title_font_weight",
				"options" => $get_theme_font_weight,
				"std" => "500",
				"desc" => esc_html__("Tabs Title Font Weight", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Tabs Title Font Family", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-tabs_title_font_family",
				"options" => $mad_google_webfonts,
				"std" => "Roboto:300,700,900,500,300italic",
				"desc" => esc_html__("Tabs Title Font Family", "revija"),
			);
			...
			$mad_elements[] = array(
				"name" => esc_html__("Post Date Font Size", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-post_date_font_size",
				"options" => "range",
				"range" => "12-20",
				"std" => "12px",
				"desc" => esc_html__("Post Date Font Size", "revija"),
			);
			
			$mad_elements[] = array(
				"name" => esc_html__("Post Label Font Size", "revija"),
				"slug" => "styling",
				"type" => "select",
				"id" => "styles-post_label_font_size",
				"options" => "range",
				"range" => "12-20",
				"std" => "12px",
				"desc" => esc_html__("Post Label Font Size", "revija"),
			);
			...
			$mad_elements[] = array(
				"name" 	=> esc_html__("Widget Tag Cloud Text Color", "revija"),
				"slug"	=> "styling",
				"type" 	=> "color",
				"id" 	=> "styles-widget_tags_text_color",
				"std" 	=> "#fff",
				"default" 	=> "#fff",
				"desc" 	=> esc_html__("Widget Tag Cloud Text Color", "revija"),
			);

			$mad_elements[] = array(
				"name" 	=> esc_html__("Widget Tag Cloud Background Color", "revija"),
				"slug"	=> "styling",
				"type" 	=> "color",
				"id" 	=> "styles-widget_tags_background_color",
				"std" 	=> "#60666b",
				"default" 	=> "#60666b",
				"desc" 	=> esc_html__("Widget Tag Cloud Background Color", "revija"),
			);
...
$mad_elements[] = array(
 ...
 $mad_elements[] = array(
		 "name" 	=> esc_html__("Floating sidebar", "revija"),
		 "slug"	=> "sidebar",
		 "type" 	=> "select",
		 "id" 	=> "floating_sidebar",
		 "options" => array(
			'floating_no' => esc_html__('no', 'revija'),
			'floating_sidebar' => esc_html__('yes', 'revija')
		 ),
		 "std" => 'no',
		 "desc" 	=> esc_html__("Floating sidebar", "revija"),
	 );
...
/* ---------------------------------------------------------------------- */
	...
	$mad_elements[] = array(
		...
		"type" 	=> "heading",
		"heading" => "h4",
		"desc" 	=> esc_html__('Editor widgets in the footer for blog pages', 'revija'),
	);

	$mad_elements[] = array(
		"name" 	=> esc_html__('Get widgets for footer from page', 'revija'),
		"slug"	=> "blog",
		"type" 	=> "select",
		"id" 	=> "blog_get_widgets_page_id",
		"options" => 'page',
		"desc" 	=> esc_html__('Get widgets for footer from page on blog pages. You can model the footer of any page and then use it to the product pages', 'revija'),
	);
...
$mad_elements[] = array(
	...
	$mad_elements[] = array(
	"name" 	=> esc_html__("Archive Settings", "revija"),
	"slug"	=> "blog",
	"type" 	=> "heading",
	"heading" => "h4",
	"desc" 	=> ' '
	...
	$mad_elements[] = array(
		"name" 	=> esc_html__("Archive Title Count", "revija"),
		"slug"	=> "blog",
		"type" 	=> "number",
		"id" 	=> "count_archive_title",
		"min" => 1,
		"max" => 100,
		"std"   => 2,
		"desc" 	=> esc_html__("Title count ( min-1, max-100 words)", "revija"),
	);
	
	$mad_elements[] = array(
		"name" 	=> esc_html__("Archive Excerpt Count", "revija"),
		"slug"	=> "blog",
		"type" 	=> "number",
		"id" 	=> "count_archive_excerpt",
		"min" => 50,
		"max" => 1000,
		"std"   => 50,
		"desc" 	=> esc_html__("Excerpt count ( min-50, max-1000 words)", "revija"),
	);
	
	
	$mad_elements[] = array(
		"name" 	=> esc_html__("Author Title Count", "revija"),
		"slug"	=> "blog",
		"type" 	=> "number",
		"id" 	=> "count_author_title",
		"min" => 1,
		"max" => 100,
		"std"   => 2,
		"desc" 	=> esc_html__("Title count page author( min-1, max-100 words)", "revija"),
	);
	
	$mad_elements[] = array(
		"name" 	=> esc_html__("Author Excerpt Count", "revija"),
		"slug"	=> "blog",
		"type" 	=> "number",
		"id" 	=> "count_author_excerpt",
		"min" => 10,
		"max" => 1000,
		"std"   => 14,
		"desc" 	=> esc_html__("Excerpt count page author ( min-10, max-1000 words)", "revija"),
	);
...
/* ---------------------------------------------------------------------- */
	...
	$mad_elements[] = array(
		"name" 	=> esc_html__("Tabs Layout", "revija"),
		"slug"	=> "shop",
		"type" 	=> "select",
		"id" 	=> "product_tab_layout",
		"options" => array(
			'vertical' => esc_html__('Vertical', 'revija'),
			'horizontal' => esc_html__('Horizontal', 'revija')
		),
		"std" => 'vertical',
		"desc" 	=> esc_html__("Choose the tabs style for the product page", "revija"),
	);
...
/* ---------------------------------------------------------------------- */
	...
	$mad_elements[] = array(
		"name" 	=> esc_html__("Import Sport News Content", "revija"),
		"slug"	=> "import",
		"desc" 	=> wp_kses(__("<p>
			<strong>View demo:</strong>
			<a target='_blank' href='http://velikorodnov.com/wordpress/revija3/'>View Demo Online</a>
			</p> You can import default content dummy posts and pages here </br> </br>
			<strong>Before Import Data install you must install and activate the following plugins: </strong>
			<ul>
				<li>Revija Content Types</li>
		...
		"id" 	=> "import_sport",
		"type" 	=> "import",
		"path" => "admin/demo/sport/sport",
		"source" => "admin/demo/sport",
		"image" => "admin/demo/sport/sport.jpg"
	);
	
	
	$mad_elements[] = array(
		"name" 	=> esc_html__("Import Furniture News Content", "revija"),
		"slug"	=> "import",
		"desc" 	=> wp_kses(__("<p>
			<strong>View demo:</strong>
			<a target='_blank' href='http://velikorodnov.com/wordpress/revija4'>View Demo Online</a>
			</p> You can import default content dummy posts and pages here </br> </br>
			<strong>Before Import Data install you must install and activate the following plugins: </strong>
			<ul>
				<li>Revija Content Types</li>
