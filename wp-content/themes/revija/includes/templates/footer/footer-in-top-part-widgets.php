<?php
	...
	if ( is_home() && get_option('show_on_front') == 'page' ) {
		$post_id = mad_custom_get_option('blog_get_widgets_page_id');
	}
...
<?php if ($footer_row_top_show == 'yes' || $footer_row_bottom_show == 'yes'): ?>
	...
	<div class="top_footer_banner top_footer_type_<?php echo esc_attr(key( json_decode( html_entity_decode ( $footer_row_top_columns_variations )))); ?>">
		<div class="container">
			<div class="row">

				<?php if (!empty($footer_row_top_columns_variations)):
					$number_of_top_columns = key( json_decode( html_entity_decode ( $footer_row_top_columns_variations )));
			...
			<div class="container">
				<div class="row">
					...
					<?php if (!empty($footer_row_bottom_columns_variations)):
						$number_of_bottom_columns = key( json_decode( html_entity_decode ( $footer_row_bottom_columns_variations )));
