...
$type_newsletter = isset( $instance['type_newsletter'] ) ? $instance['type_newsletter'] : 'type1';
...
<p>
<label for="<?php echo esc_attr($this->get_field_id('style_type')); ?>"><?php esc_html_e('Style Button:', 'revija'); ?></label>
...
<p>
<label for="<?php echo esc_attr($this->get_field_id('type_newsletter')); ?>"><?php esc_html_e('Style form:', 'revija'); ?></label>
<select class="widefat" id="<?php echo esc_attr($this->get_field_id('type_newsletter')); ?>" name="<?php echo esc_attr($this->get_field_name('type_newsletter')); ?>">
	<option value="type1"<?php selected( $type_newsletter, 'type1' ); ?>><?php esc_html_e( 'type1', 'revija' ); ?></option>
	<option value="type2"<?php selected( $type_newsletter, 'type2' ); ?>><?php esc_html_e( 'type2', 'revija' ); ?></option>
</select>
</p>
