...
<p>
	...
	<input class="widefat" type="text" id="<?php echo esc_attr($widget->get_field_id('contact_us')); ?>" name="<?php echo esc_attr($widget->get_field_name('contact_us')); ?>" value="<?php echo esc_attr($instance['contact_us']); ?>" />
		...
		<select name="<?php echo esc_attr($widget->get_field_name('type_display')); ?>" id="<?php echo esc_attr($widget->get_field_id('type_display')); ?>" class="widefat">
			<option value="type1"<?php selected( $instance['type_display'], 'type1' ); ?>><?php esc_html_e( 'Type1', 'revija' ); ?></option>
			<option value="type_2 tool_down"<?php selected( $instance['type_display'], 'type_2 tool_down' ); ?>><?php esc_html_e( 'Type2', 'revija' ); ?></option>
		</select>
		</p>
