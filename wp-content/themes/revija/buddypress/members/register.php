	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<div class="register-section" id="basic-details-section">
				...
				<h4><?php esc_html_e( 'Account Details', 'buddypress' ); ?></h4>
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section" id="profile-details-section">
					...
					<h4><?php esc_html_e( 'Profile Details', 'buddypress' ); ?></h4>
						...
						<div<?php bp_field_css_class( 'editfield' ); ?>>
							...
							if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
								<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
									<?php printf( esc_html__( 'This field can be seen by: %s', 'buddypress' ), bp_get_the_profile_field_visibility_level_label() ) ?> <a href="#" class="visibility-toggle-link"><?php _ex( 'Change', 'Change profile field visibility level', 'buddypress' ); ?></a>
								</p>
							...
							<?php else : ?>
								<p class="field-visibility-settings-notoggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
									<?php printf( esc_html__( 'This field can be seen by: %s', 'buddypress' ), bp_get_the_profile_field_visibility_level_label() ) ?>
								</p>
							<?php endif ?>
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
				...
				<div class="register-section" id="blog-details-section">
					...
					<h4><?php esc_html_e( 'Blog Details', 'buddypress' ); ?></h4>

					<p><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'Yes, I\'d like to create a new site', 'buddypress' ); ?></p>
					...
					<div id="blog-details"<?php if ( (int) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
						...
						<span class="label"><?php esc_html_e( 'I would like my site to appear in search engines, and in public listings around this network.', 'buddypress' ); ?></span>
						<?php
						...
						<label><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_public" value="public"<?php if ( 'public' == bp_get_signup_blog_privacy_value() || !bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'Yes', 'buddypress' ); ?></label>
						<label><input type="radio" name="signup_blog_privacy" id="signup_blog_privacy_private" value="private"<?php if ( 'private' == bp_get_signup_blog_privacy_value() ) : ?> checked="checked"<?php endif; ?> /> <?php esc_html_e( 'No', 'buddypress' ); ?></label>
			...
			<div class="submit">
				<input class="button button_grey" type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
			</div>
