...
$title_count = mad_custom_get_option("count_archive_title");
$text_count = mad_custom_get_option("count_archive_excerpt");

$post_content =  revija_limit_words($post_content, $text_count);
$title =  revija_limit_words($title, $title_count);
